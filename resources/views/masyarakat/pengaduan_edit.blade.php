                ...
                <div class="card-body">
                    <form action="{{ route('pengaduan.update', $pengaduan->slug) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea name="isi_laporan" id="isi_laporan" cols="" rows="5" class="form-control @error('isi_laporan') is-invalid @enderror">{{ old('isi_laporan') }}{{ $pengaduan->isi_laporan }}</textarea>
                        ...
                        <div class="col-md-8 offset-md-4">
                            <img src="{{ asset($pengaduan->foto) }}" class="w-75" alt="">
                        </div>
                        @endif
